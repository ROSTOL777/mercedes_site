const linksHead = document.querySelectorAll('.menu-list__link') // (1) получаем все ссылки из менюшки
const mainscroll = document.querySelector('.main__scroll') // (2) получаем класс ссылки кнопки белой стрелки вниз
