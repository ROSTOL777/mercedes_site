const tabs = (dataTabsHandler, dataTabsField) => {
    const tabsHandlerElems = document.querySelectorAll(dataTabsHandler)  // (1) записываем дата атрибут data-tabs-handler в переменную tabsHandlerElems
    const tabsContentElems = document.querySelectorAll(dataTabsField)  // (2) записываем дата атрибут data-tabs-field в переменную tabsContentElems
